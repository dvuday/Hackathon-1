...
int main() {
    ...
    do {
	    ...
	    printf("5. Them mot phan tu vao vi tri ngau nhien trong mang,phan tu moi va vi tri them vao mang do nguoi dung nhap vao.chi them phan tu do vao mang neu phan tu do chua ton tai trong mang.\n");
